...
class SingleThreadQueryCountTestCase(ModuleStoreTestCase):
    ...
    @ddt.data(
        ...
        (ModuleStoreEnum.Type.mongo, 1, 6, 4, 16, 4),
        (ModuleStoreEnum.Type.mongo, 50, 6, 4, 16, 4),
        # split mongo: 3 queries, regardless of thread response size.
        (ModuleStoreEnum.Type.split, 1, 3, 3, 15, 4),
        (ModuleStoreEnum.Type.split, 50, 3, 3, 15, 4),
    )
    @ddt.unpack
