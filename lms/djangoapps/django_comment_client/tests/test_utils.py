...
class CategoryMapTestCase(CategoryMapTestMixin, ModuleStoreTestCase):
            ...
            self.assert_category_map_equals(
                {
                    ...
                    "subcategories": {},
                    "children": [("Topic A", 'entry'), ("Topic B", "entry"), ("Topic C", "entry")]
                }
            )
        ...
        self.assert_category_map_equals(
            {
                ...
                "subcategories": {
                    "Chapter 1": {
                        ...
                        "subcategories": {},
                        "children": [("Discussion 1", "entry")],
                        "start_date": later,
                        "sort_key": "Chapter 1"
                    }
                },
                "children": [("Chapter 1", "subcategory")]
            },
            cohorted_if_in_list=True,
            ...
            self.assert_category_map_equals(
                {
                    ...
                    "subcategories": {
                        "Chapter 1": {
                            ...
                            "subcategories": {},
                            "children": [("Discussion 1", "entry"), ("Discussion 2", "entry")]
                        },
                        "Chapter 2": {
                            "entries": {
                                "Discussion": {
                            ...
                            "subcategories": {
                                "Section 1": {
                                    ...
                                    "children": [("Subsection 1", "subcategory"), ("Subsection 2", "subcategory")]
                                }
                            },
                            "children": [("Discussion", "entry"), ("Section 1", "subcategory")]
                        },
                        "Chapter 3": {
                            "entries": {},
                            "subcategories": {
                            ...
                            "children": [("Section 1", "subcategory")]
                        }
                    },
                    "children": [("Chapter 1", "subcategory"), ("Chapter 2", "subcategory"), ("Chapter 3", "subcategory")]
                }
            )
    ...
    def test_tree_with_duplicate_targets(self):
        ...
        chapter1_discussions_with_types = set([("Discussion A","entry"), ("Discussion B", "entry"), ("Discussion A (1)", "entry"), ("Discussion A (2)", "entry")])
        ...
        subsection1_discussions_with_types = set([("Discussion", "entry"), ("Discussion (1)", "entry")])
        ...
        self.assert_category_map_equals(
            {
                ...
                "children": [("Chapter 1", "subcategory"), ("Chapter 2", "subcategory")]
            }
        )
        ...
        self.assert_category_map_equals(
            {
                ...
                "subcategories": {},
                "children": [("Topic C", "entry"), ("Topic A", "entry"), ("Topic B", "entry")]
            }
        )
        ...
        self.assert_category_map_equals(
            {
                ...
                "children": [("Chapter A", "subcategory"), ("Chapter B", "subcategory"), ("Chapter C", "subcategory")]
            }
        )
