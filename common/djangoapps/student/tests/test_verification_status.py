...
class TestCourseVerificationStatus(UrlResetMixin, ModuleStoreTestCase):
    ...
    @override_settings(VERIFY_STUDENT={"DAYS_GOOD_FOR": 5, "VERIFICATION_EXPIRATION_DAYS": 10})
    def test_verification_will_expire_by_deadline(self):
        ...
        # Expect that learner can submit photos if verification is set to expired soon.
